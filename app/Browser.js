    ...
    render() {
        ...
        return (
            <View style={styles.root}>
                ...
                <StatusBar backgroundColor="#194376" />
                <Appbar style={{ backgroundColor: "#194376", justifyContent: "space-evenly" }} >
                    <View style={{ flexDirection: "row", width: "15%", justifyContent: "space-around" }} >
                        <TouchableOpacity onPress={this.goBack} >
                            <MaterialCommunityIcons name="arrow-left" size={RFPercentage(3)} color="white" />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={this.goForward} >
                            <MaterialCommunityIcons name="arrow-right" size={RFPercentage(3)} color="white" />
                        </TouchableOpacity>
                    </View>
                    <TextInput
                        ...
                        value={urlText}
                    />
                    <View style={{ flexDirection: "row", width: "17%", justifyContent: "space-around" }} >
                        <TouchableOpacity onPress={this.loadURL} >
                            <MaterialCommunityIcons name="search-web" size={RFPercentage(3.3)} color="white" />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={this.reload} >
                            <MaterialCommunityIcons name="refresh" size={RFPercentage(3.3)} color="white" />
                        </TouchableOpacity>
                    </View>
                </Appbar>
